...
export function registerInspectTool(server: McpServer): void {
  server.tool(
    'inspect',
    'List all MetaCall-loaded functions with their argument names, types, and return type. ' +
    'Use this before calling call_function to discover what is available.',
    {},
    async () => {
...
function mapMetaCallType(type: string): string {
